    ...
    return (
        <div className={`admin-dashboard ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
            ...
            <main className="admin-main-content">
                ...
                {/* 📄 System Functionality & Operational User Guide (PDF & Interactive Modal) */}
                {isSystemGuideOpen && (
                    <div className="admin-modal-overlay animate-in" style={{ zIndex: 1200, padding: '20px' }} onClick={() => setIsSystemGuideOpen(false)}>
                        <div className="admin-modal-content system-guide-modal" style={{ maxWidth: '920px', width: '100%', maxHeight: '90vh', display: 'flex', flexDirection: 'column', padding: '0', borderRadius: '24px', overflow: 'hidden', background: '#ffffff' }} onClick={e => e.stopPropagation()}>
                            
                            {/* Guide Top Action Header (Hidden during browser print) */}
                            <div className="system-guide-header no-print" style={{ background: '#0f172a', color: '#ffffff', padding: '20px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                    <div style={{ background: '#ffffff', padding: '3px 8px', borderRadius: '8px', display: 'flex', alignItems: 'center' }}>
                                        <img src={HIRA_LOGO} alt="HIRA Advertising" style={{ height: '28px', width: 'auto', display: 'block', objectFit: 'contain' }} />
                                    </div>
                                    <div>
                                        <h3 style={{ margin: 0, fontSize: '1.2rem', fontWeight: 900, color: '#ffffff', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            <span>System Functionality & User Guide</span>
                                            <span style={{ background: '#3b82f6', color: '#ffffff', fontSize: '0.7rem', fontWeight: 800, padding: '2px 8px', borderRadius: '20px' }}>OFFICIAL GUIDE</span>
                                        </h3>
                                        <p style={{ margin: '2px 0 0', fontSize: '0.78rem', color: '#94a3b8' }}>
                                            Complete screen breakdown, core operational workflows & business problems solved
                                        </p>
                                    </div>
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <button
                                        ...
                                        onClick={() => {
                                            if (navigator.clipboard) {
                                                navigator.clipboard.writeText(`HIRA Advertising OOH Management Platform: Complete Functionality & Solutions Guide.\nIncludes Executive Dashboard, 50m GPS Geofenced Field Audits, Live Excel Sync, Daily Gemini AI Verification, and Client Proposals.`);
                                                showToast('Guide summary copied to clipboard!');
                                            }
                                        }}
                                        style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: '#cbd5e1', padding: '8px 14px', borderRadius: '10px', fontSize: '0.8rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                                    >
                                    ...
                                    <button
                                        ...
                                        style={{ background: '#10b981', border: 'none', color: '#ffffff', padding: '8px 16px', borderRadius: '10px', fontSize: '0.82rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', boxShadow: '0 4px 12px rgba(16,185,129,0.3)' }}
                                    >
                                        <Printer size={15} /> Print / Save as PDF
                                    </button>
                                    <button
                                        type="button"
                                        onClick={() => setIsSystemGuideOpen(false)}
                                        style={{ background: 'rgba(255,255,255,0.1)', border: 'none', color: '#ffffff', width: '36px', height: '36px', borderRadius: '50%', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                    >
                                        <X size={18} />
                                    </button>
                                </div>
                            ...
                            <div className="system-guide-body print-document" style={{ padding: '32px 36px', overflowY: 'auto', flex: 1, color: '#1e293b', lineHeight: 1.6, background: '#f8fafc' }}>
                                
                                {/* Document Header for Print */}
                                <div style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '24px', boxShadow: '0 4px 14px rgba(0,0,0,0.03)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '14px', marginBottom: '14px' }}>
                                        <div>
                                            <span style={{ fontSize: '0.74rem', fontWeight: 900, color: '#4f46e5', textTransform: 'uppercase', letterSpacing: '0.05em' }}>HIRA ADVERTISING PRIVATE LIMITED</span>
                                            <h1 style={{ margin: '4px 0', fontSize: '1.65rem', fontWeight: 900, color: '#0f172a', letterSpacing: '-0.02em' }}>
                                                Outdoor Media Operations & Management System
                                            </h1>
                                            <p style={{ margin: 0, fontSize: '0.9rem', color: '#64748b' }}>
                                                Platform Architecture, Screen Functionalities & Operational Problems Solved
                                            </p>
                                        </div>
                                        <div style={{ background: '#f1f5f9', padding: '10px 16px', borderRadius: '12px', textAlign: 'right' }}>
                                            <strong style={{ display: 'block', fontSize: '0.85rem', color: '#0f172a' }}>Standard Operating Manual</strong>
                                            <span style={{ fontSize: '0.74rem', color: '#64748b' }}>Updated: 2026 Edition</span>
                                        </div>
                                    </div>
                                    <div style={{ height: '1px', background: '#e2e8f0', margin: '14px 0' }} />
                                    <p style={{ margin: 0, fontSize: '0.85rem', color: '#475569' }}>
                                        This document serves as the comprehensive manual explaining every screen in the system, its direct operational functions, and the high-value business challenges it solves for advertisers, field teams, and administrative management.
                                    </p>
                                </div>

                                {/* Section 1: Executive Dashboard */}
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        <div style={{ background: '#eff6ff', color: '#2563eb', padding: '10px', borderRadius: '12px', display: 'flex' }}>
                                            <LayoutDashboard size={22} />
                                        </div>
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>1. Executive Dashboard (Performance Insights)</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#2563eb', fontWeight: 700 }}>Real-Time Revenue, Occupancy & Corridor Analytics</span>
                                        </div>
                                    </div>
                                    
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Displays live Total Hoardings, Active Client Campaigns, and Real-Time Occupancy Rate.</li>
                                                <li>Calculates estimated Monthly Revenue Potential and Gross Annualized Yield.</li>
                                                <li>Shows Arterial Corridor Distribution (Delhi Road, Begum Bridge, Garh Road, etc.) with visual density bar graphs.</li>
                                                <li>Breakdown of Commercial Price Tiers and Total Sq. Ft. display coverage.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                <li><strong>Eliminates Manual Math & Uncertainty:</strong> Business owners no longer need to manually tally spreadsheets to know which billboards are vacant or generating revenue.</li>
                                                <li><strong>Maximizes Sales Velocity:</strong> Instantly identifies under-utilized corridors so sales teams can run targeted promotions on vacant inventory.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        <div style={{ background: '#f5f3ff', color: '#7c3aed', padding: '10px', borderRadius: '12px', display: 'flex' }}>
                                            <Database size={22} />
                                        </div>
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>2. Master Asset Inventory Management</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#7c3aed', fontWeight: 700 }}>Comprehensive Billboard Catalog, Filtering & Instant Status Controls</span>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Comprehensive searchable table of all outdoor media assets (Billboards, Unipoles, Gantries).</li>
                                                <li>Multi-dimensional filters: City, Locality, Dimensions (Width x Height), Media Type (Front Lit/Back Lit), and Price Bracket.</li>
                                                <li>1-click Live Status toggles: Available, Occupied (with Client Name & Booking dates), or Disabled (Offline).</li>
                                                <li>Quick edit modal for updating monthly rental, dimensions, facing traffic, or photo.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                <li><strong>Zero Double-Booking Disasters:</strong> Prevents two sales managers from selling the same billboard to different advertisers simultaneously.</li>
                                                <li><strong>Instant Client Quotations:</strong> When a client asks for "Front-lit unipoles in Meerut under ₹50,000", results are found in under 2 seconds.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

                                {/* Section 3: Live Excel Sheet Editor */}
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        ...
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>3. Live Master Excel Sheet Grid</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#059669', fontWeight: 700 }}>In-App Spreadsheet Grid & Two-Way Real-Time Synchronization</span>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Embedded high-performance Tabulator spreadsheet grid right inside the admin dashboard.</li>
                                                <li>Direct cell editing with keyboard navigation (Arrow keys, Enter, Tab) and undo/redo history.</li>
                                                <li>Instant "Save & Sync" button that updates master Google Sheets backend in real time.</li>
                                                <li>Column sorting, column filtering, and full-screen spreadsheet focus mode.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                <li><strong>No More Broken Formulas or External Tab Switching:</strong> Power users who love Excel can perform rapid bulk updates without leaving the application or risking formula corruption.</li>
                                                <li><strong>Single Source of Truth:</strong> Edits instantly sync to both the cloud master sheet and the live client-facing discovery website.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        ...
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>4. Live Field Audit & Staff Uploads (Staff Mobile Camera)</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#ea580c', fontWeight: 700 }}>50-Meter GPS Geofenced Verification, Pinpoint Map & Approval Workflow</span>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Ground staff use the dedicated Mobile Camera App (or Android APK) with built-in GPS and AI Voice guidance.</li>
                                                <li>Captures are automatically tested against a 50-meter GPS radius of all registered hoardings.</li>
                                                <li>Auto-approved photos save directly into hoarding history; borderline or multi-site clusters appear in the Review Queue.</li>
                                                <li>Clicking "📍 GPS Map" opens an interactive OpenStreetMap satellite pinpoint showing the exact meter distance from site.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                <li><strong>Eliminates Fake & Recycled Proof Photos:</strong> Solves the biggest problem in outdoor advertising where field staff submit old or wrong-site photos. Photos cannot be submitted without live GPS coordinates.</li>
                                                <li><strong>Zero Downtime Offline Queue:</strong> Field staff in remote highway locations can capture photos offline; uploads sync automatically when mobile data is restored.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        <div style={{ background: '#fdf2f8', color: '#db2777', padding: '10px', borderRadius: '12px', display: 'flex' }}>
                                            <Zap size={22} />
                                        </div>
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>5. Daily AI Updates (Batch Photo Automation)</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#db2777', fontWeight: 700 }}>Gemini Vision AI, Printed Watermark OCR & Auto Status Tagging</span>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Admins drag & drop dozens of daily execution photos taken by third-party mounting teams.</li>
                                                <li>Gemini Vision AI inspects printed GPS timestamps, camera watermarks, road landmarks, and mounted brand flex.</li>
                                                <li>Auto-detects whether the site is "Occupied" (brand ad mounted) or "Available" (torn / blank flex / to-let).</li>
                                                <li>One-click "Confirm & Sync" updates the master database and publishes fresh photos to the live site.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                ...
                                                <li><strong>Instant Campaign Proof Turnaround:</strong> Corporate brands receive daily mounting proof within minutes of execution instead of days.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="guide-card" style={{ background: '#ffffff', border: '1.5px solid #e2e8f0', borderRadius: '18px', padding: '24px', marginBottom: '20px', boxShadow: '0 4px 14px rgba(0,0,0,0.02)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                        <div style={{ background: '#f0fdf4', color: '#16a34a', padding: '10px', borderRadius: '12px', display: 'flex' }}>
                                            <User size={22} />
                                        </div>
                                        <div>
                                            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, color: '#0f172a' }}>6. Client Relationship Portals & Proposal Generator</h2>
                                            <span style={{ fontSize: '0.75rem', color: '#16a34a', fontWeight: 700 }}>1-Click Excel Proposal Deck & Dedicated Advertiser Verification Portals</span>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginTop: '14px' }}>
                                        <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#0f172a', marginBottom: '6px' }}>🖥️ What Is Happening on Screen:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#475569', lineHeight: '1.6' }}>
                                                <li>Check any selection of hoardings across cities and click "Export Proposal" to download a clean, client-ready Excel deck.</li>
                                                <li>CRM Client View groups campaigns by advertiser (e.g. Maruti Suzuki, Samsung, Local Brands).</li>
                                                <li>Generates permanent shareable portal links (`/client/[ClientName]`) for live campaign inspection.</li>
                                            </ul>
                                        </div>
                                        <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px' }}>
                                            <strong style={{ display: 'block', fontSize: '0.86rem', color: '#166534', marginBottom: '6px' }}>🎯 Real-World Problem Solved:</strong>
                                            <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '0.82rem', color: '#14532d', lineHeight: '1.6' }}>
                                                <li><strong>Closes Sales Proposals 10x Faster:</strong> Sales reps can prepare and email tailored multi-city proposals in 30 seconds instead of hours.</li>
                                                <li><strong>100% Client Retention & Trust:</strong> Clients can view their active hoarding campaign live from anywhere with geotagged photo proof.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

                                {/* Summary Table of Problems Solved */}
                                <div style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #0f172a 100%)', color: '#ffffff', borderRadius: '18px', padding: '24px', marginTop: '10px' }}>
                                    <h3 style={{ margin: '0 0 14px 0', fontSize: '1.15rem', fontWeight: 900, color: '#ffffff' }}>
                                        🏆 Summary: Core Business Problems Solved
                                    </h3>
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
                                        <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '12px', padding: '14px' }}>
                                            <strong style={{ color: '#818cf8', display: 'block', fontSize: '0.84rem', marginBottom: '4px' }}>🚫 Fake Audits Eliminated</strong>
                                            <span style={{ fontSize: '0.78rem', color: '#cbd5e1' }}>50m GPS geofencing guarantees photos are taken on-site at the exact billboard location.</span>
                                        </div>
                                        <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '12px', padding: '14px' }}>
                                            <strong style={{ color: '#34d399', display: 'block', fontSize: '0.84rem', marginBottom: '4px' }}>⚡ Zero Manual Data Entry</strong>
                                            <span style={{ fontSize: '0.78rem', color: '#cbd5e1' }}>Gemini AI and direct Excel sync eliminate manual copy-pasting across disparate spreadsheets.</span>
                                        </div>
                                        <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '12px', padding: '14px' }}>
                                            <strong style={{ color: '#fbbf24', display: 'block', fontSize: '0.84rem', marginBottom: '4px' }}>📈 Revenue Maximization</strong>
                                            <span style={{ fontSize: '0.78rem', color: '#cbd5e1' }}>Vacant hoarding alerts and instant proposal exports prevent unrented inventory downtime.</span>
                                        </div>
                                        <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '12px', padding: '14px' }}>
                                            <strong style={{ color: '#60a5fa', display: 'block', fontSize: '0.84rem', marginBottom: '4px' }}>📶 Offline Field Capability</strong>
                                            <span style={{ fontSize: '0.78rem', color: '#cbd5e1' }}>Field teams can capture photos on highways with zero internet; background sync resumes automatically.</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Modal Footer */}
                            <div className="system-guide-footer no-print" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #e2e8f0', padding: '16px 28px', background: '#ffffff' }}>
                                <span style={{ fontSize: '0.78rem', color: '#64748b' }}>
                                    HIRA Advertising OOH Management Platform • Official Operational Manual
                                </span>
                                <div style={{ display: 'flex', gap: '10px' }}>
                                    <button
                                        type="button"
                                        onClick={() => window.print()}
                                        style={{ padding: '10px 20px', borderRadius: '12px', border: '1px solid #cbd5e1', background: '#f8fafc', color: '#0f172a', fontSize: '0.85rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                                    >
                                    ...
                                    <button 
                                        type="button" 
                                        onClick={() => setIsSystemGuideOpen(false)}
                                        style={{ padding: '10px 24px', borderRadius: '12px', border: 'none', background: '#4f46e5', color: '#ffffff', fontSize: '0.85rem', fontWeight: 800, cursor: 'pointer', boxShadow: '0 4px 14px rgba(79,70,229,0.3)' }}
                                    >
                                        Close
                                    </button>
                                </div>
